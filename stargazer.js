document.addEventListener("DOMContentLoaded", function() {
  ...
  // Set while loop for generating stars
      ...
      CONTAINER.insertAdjacentHTML('afterbegin', '<div class="' + setStargazer["generateItemClass"] + '" id="' + setStargazer["generateItemClass"] + '-' + quantityCounter +'" style="position:absolute">' + setStargazer["generateItemContent"] + '</div>');
      ++quantityCounter;
      };
